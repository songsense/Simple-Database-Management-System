...
int main() {
	...
	if (createLeftTable() != success) {
		cerr << "fail when creating left table" << endl;
		goto print_point;
	}

	if (testCase_1() != success) {
		cerr << "fail test case 1" << endl;
		goto print_point;
	}
	g_nGradPoint += 5;
	g_nUndergradPoint += 5;
	...
	if (createRightTable() != success) {
		cerr << "fail when creating right table" << endl;
		goto print_point;
	}

	if (testCase_2() != success) {
		cerr << "fail test case 2" << endl;
		goto print_point;
	}
	g_nGradPoint += 5;
	g_nUndergradPoint += 5;
	...
	if (testCase_9_Grad() == success) {
		...
		cerr << "fail test case graduate" << endl;
	}
	...
	if (testCase_9_Undergrad() == success) {
		...
		cerr << "fail test case 9 undergraduate" << endl;
	}
	...
	if (createRightVarCharTable() != success) {
		cerr << "fail createRightVarCharTable" << endl;
		goto print_point;
	}

	if (populateRightVarCharTable() != success) {
		cerr << "fail populateRightVarCharTable" << endl;
		goto print_point;
	}
	...
	if (extraTestCase_1() == success) {
		...
		cerr << "fail extra test case 1" << endl;
	}
	...
	if (extraTestCase_2() == success) {
		...
		cerr << "fail extra test case 2" << endl;
	}

	if (createGroupTable() != success) {
		goto print_point;
	} else {
		cerr << "createGroupTable" << endl;
	}

	if (populateGroupTable() != success) {
		goto print_point;
	} else {
		cerr << "populateGroupTable" << endl;
	}
    ...
    if (extraTestCase_3() == success) {
		...
		cerr << "fail extra test case 3" << endl;
	}
