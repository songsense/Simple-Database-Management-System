...
void Test21()
{
  ...
  exec("SELECT AGG salary GROUPBY(Explanation) GET AVG(Salary)");
...
void clearAll() {
	...
	remove("tbl_employee_Age");
	remove("../tbl_employee_Age");

	remove("tbl_employee_Height");
	remove("../tbl_employee_Height");

	remove("tbl_employee_EmpName");
	remove("../tbl_employee_EmpName");

	remove("tbl_employee2_Age");
	remove("../tbl_employee2_Age");

	remove("tbl_employee2_EmpName");
	remove("../tbl_employee2_EmpName");

	remove("tbl_employee2_Height");
	remove("../tbl_employee2_Height");
